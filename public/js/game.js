...
function resetGame() {
  game = {
    ...
    distanceForSpeedUpdate: 1000, // <--- Se incrementa *10 para evitar que el usuario sienta demasiada velocidad
    speedLastUpdate: 0,
...
Sea = function () {
  ...
  for (var i = 0; i < l; i++) {
    ...
    this.waves.push({
      ...
      speed:
        game.wavesMinSpeed + Math.random() * (game.wavesMaxSpeed - game.wavesMinSpeed),
    });
  }
...
EnnemiesHolder.prototype.rotateEnnemies = function () {
  for (var i = 0; i < this.ennemiesInUse.length; i++) {
    ...
    // Se valida si el avion se golpea con un enemigo || DETECTA COLISION
...
function updateDistance() {
  ...
  var d =
    502 *
    (1 - (game.distance % game.distanceForLevelUpdate) / game.distanceForLevelUpdate);
